...
{
    /// <summary>
    /// Builds and executes requests for operations under \predictions\{predictionId}\cancel
    /// </summary>
    ...
    public partial class CancelRequestBuilder : BaseRequestBuilder
    {
        ...
        public CancelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/predictions/{predictionId}/cancel", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Replicate.OpenApiClient.Predictions.Item.Cancel.CancelRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CancelRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/predictions/{predictionId}/cancel", rawUrl)
        {
        }
        /// <summary>
